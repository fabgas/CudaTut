...
public class Threads {
	...
	static int blocks = 10;
  	static int threads = 2; // threads par block ? limite 1024
    ...
    public static void prepare()
    {
        ...
        try
        {
            ptxFileName = preparePtxFile("threads.cu");
        }
        catch (IOException e)
        {
        ...
        cuModuleGetFunction(function, module, "threads");
